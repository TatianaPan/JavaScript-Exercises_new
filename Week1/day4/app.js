...
class Game {
    constructor () {
        ...
        this.paddle = new Paddle(20, 100, 440, 0);
    ...
    checkCollisions() {
        if (this.ball.ballX + this.ball.ballRadius >= canvas.width - this.paddle.width
            && (this.ballY - this.ball.ballRadius < this.paddle.upDown + this.paddle.heigth 
                && this.ball.ballY + this.ball.ballRadius > this.paddle.upDownUp)) {
                console.log('Collision!!');
        } else if (this.ball.ballX + this.ball.ballRadius >= canvas.width || this.ball.ballY + this.ball.ballRadius >= canvas.height
            || this.ball.ballX - this.ball.ballRadius == 0 || this.ball.ballY - this.ball.ballRadius == 0) {
